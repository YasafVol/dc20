import "./chunk-NPTZCMPG.js";
import "./chunk-MD6QXAL4.js";
import {
  dequal
...
import {
  ...
  readonly,
  writable
} from "./chunk-ZAXXRGOF.js";
import "./chunk-U7P2NEEE.js";
import "./chunk-CYNT5I6N.js";
import {
  tick
} from "./chunk-E3LOZPHR.js";
import "./chunk-HOOIHJAO.js";
...
function getElementByMeltId(id, rootElement) {
  if (!isBrowser)
    return null;
  const el = (rootElement ?? document).querySelector(`[data-melt-id="${id}"]`);
  return isHTMLElement(el) ? el : null;
}
function getElementById(id, rootElement) {
  if (!isBrowser)
    return null;
...
// node_modules/@melt-ui/svelte/dist/internal/helpers/pointer.js
...
// node_modules/@melt-ui/svelte/dist/internal/actions/prevent-text-selection-overflow/action.js
...
var useInteractOutside = (node, config = {}) => {
  ...
  const setupBubblePhaseHandlerAndMarkAsNotIntercepted = (eventType, handler) => {
    return addEventListener(documentObj, eventType, (e) => {
      ...
      handler == null ? void 0 : handler(e, computedData);
    });
  };
  function update(config2) {
    unsubEvents();
    ...
    const onPointerDownDebounced = debounce((e, computedEventData) => {
      ...
      const target = (computedEventData == null ? void 0 : computedEventData.shadowTarget) ? computedEventData.shadowTarget : e.target;
...
function createListbox(props) {
  ...
  const { scrollAlignment, loop, closeOnOutsideClick, escapeBehavior, preventScroll, portal, forceVisible, positioning, multiple, arrowSize, disabled, required, typeahead, name: nameProp, highlightOnHover, onOutsideClick, preventTextSelectionOverflow: preventTextSelectionOverflow2, rootElement } = options;
  const $rootElement = rootElement.get();
  if (isBrowser && $rootElement === void 0) {
    rootElement.set(document);
  } else {
    if ((props == null ? void 0 : props.portal) === void 0) {
...
var createSlider = (props) => {
  ...
  const getAllThumbs = () => {
    const root2 = getElementByMeltId(meltIds.root, rootElement.get());
    if (!root2)
      return null;
  ...
  effect([root, min, max, disabled, orientation, direction, step], ([$root, $min, $max, $disabled, $orientation, $direction, $step]) => {
    ...
    const pointerUp = () => {
      if ((withDefaults == null ? void 0 : withDefaults.onValueCommitted) && isActive.get()) {
        withDefaults.onValueCommitted(value.get());
      }
      isActive.set(false);
    };
...
// node_modules/@melt-ui/svelte/dist/builders/table-of-contents/create.js
var defaults30 = {
  exclude: ["h1"],
  scrollOffset: 0,
...
function createTableOfContents(args) {
  ...
  const { selector: selector10, exclude, activeType, rootMargin, scrollBehaviour, scrollOffset, headingFilterFn, scrollFn, pushStateFn } = argsWithDefaults;
...
// node_modules/@melt-ui/svelte/dist/builders/tags-input/helpers.js
...
// node_modules/@melt-ui/svelte/dist/sync.js
function keys(obj) {
